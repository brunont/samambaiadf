...
<html>
  <head>
    ...
    -->
    <title>SamambaiaDF.net - Informações dos Equipamentos Sociais de Samambaia-DF</title>    
    <meta name="description" content="Plataforma online que proporciona a localização e a troca de informações sobre os equipamentos sociais da regional de Samambaia, no Distrito Federal">
    <meta name="author" content="Bruno e Thais">
    <meta name="keywords" content="Samambaia, Projeto Social, Troca de Informações, Sociedade, Cidadania, Plataforma Social, Hospitais, Saúde, Esporte, Lazer, Cultura, Crowdsourcing, Equipamentos Sociais"/>
    ...
    <script type="text/javascript">
      ...
      function initialize() {
        ...
        var myOptions = {
          zoom: 14,
          //minZoom: 10,
          center: new google.maps.LatLng(-15.8773, -48.0955),
        ...
        <?php
          $types = Array(
              Array('startup', 'Educação'),
              Array('accelerator','Saúde'),
              Array('incubator', 'Esporte'), 
              Array('coworking', 'Lazer'), 
              Array('investor', 'Assistência Social'),
              Array('service', 'Assistência Jurídica'),
              Array('hackerspace', 'Organizações Assistenciais')
              );
          $marker_id = 0;
  ...
  <body>
    ...
    <script>(function(d, s, id) {
      ...
      js.src = "//connect.facebook.net/en_US/all.js#xfbml=1&appId=260801140667435";
    ...
    <div class="topbar" id="topbar">
      <div class="wrapper">
        <div class="right">
          <div class="share">
            <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://samambaiadf.net/" data-text="Eu também uso e compartilho as informações de Samambaia!" data-via="" data-count="none">Tweet</a>
            <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
            <div class="fb-like" data-href="http://www.facebook.com/pages/Samambaiadf/158135151031850" data-send="false" data-layout="button_count" data-width="100" data-show-faces="false" data-font="arial"></div>
          </div>
        </div>
        <div class="left">
          <div class="logo">
          ...
          <div class="buttons">
            <a href="#modal_info" class="btn btn-large btn-info" data-toggle="modal"><i class="icon-info-sign icon-white"></i>Sobre o SamambaiaDF.net</a>
            <?php if($sg_enabled) { ?>
              <a href="#modal_add_choose" class="btn btn-large btn-success" data-toggle="modal"><i class="icon-plus-sign icon-white"></i>Adicionar</a>
            <? } else { ?>
              <a href="#modal_add" class="btn btn-large btn-success" data-toggle="modal"><i class="icon-plus-sign icon-white"></i>Adicionar</a>
            <? } ?>
          </div>
          <div class="search">
            <input type="text" name="search" id="search" placeholder="Pesquisar..." data-provide="typeahead" autocomplete="off" />
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="menu" id="menu">
      <ul class="list" id="list">
        ...
        ?>
        <li class="blurb">
          Este mapa foi criado para facilitar o acesso e compartilhamento dos espaços sociais de Samambaia-DF. Participe e ajude a divulgar ;-)
        </li>
        <li class="attribution">
          Sistema baseado no <a href="http://www.represent.la" target="_blank">RepresentLA</a>
        </li>
      </ul>
    </div>
    ...
    <div class="modal hide" id="modal_info">
      <div class="modal-header">
        ...
        <h3>Sobre o SamambaiaDF.net</h3>
      </div>
      <div class="modal-body" style="text-align:justify">
        <center><img src="images/logo.png" alt="" style="padding-bottom:20px"></center>
        <p>
          Esta plataforma digital é uma construção conjunta de profissionais das áreas da saúde e da computação, que possuem um objetivo em comum: construir uma sociedade mais justa e cidadã. A partir desse objetivo e de muitas conversas sobre saúde, cidadania e tecnologia, começamos a desenhar um projeto que facilitasse tanto o acesso, quanto a troca de informações dos equipamentos sociais. 
        </p>
        <p>
          Foi assim que surgiu o SamambaiaDF, uma plataforma online que proporciona a localização e a troca de informações sobre os equipamentos sociais da regional de Samambaia, no Distrito Federal. Aqui você pode acrescentar novos locais e informações de cursos, esporte, lazer, educação, saúde entre outros, e relatar suas experiências em cada local. 
        </p>
        <p>
          Você conhece uma igreja que oferece algum curso? Uma escola que realiza algum esporte? Um local de saúde que oferece alguma atividade física? Compartilhe aqui suas informações, ajude-nos a criar essa plataforma que tem como principal objetivo informar a população sobre os serviços prestados e sua qualidade. Vamos criar uma sociedade amiga, solidária e principalmente cidadã?!!
        </p>
        <p>
          Esse projeto só existe se tiver VOCÊ como parceiro!!!<br/>
          Obrigado... 
        </p>
        <p>
          <b>SamambaiaDF</b>, <em>open-source, open-data</em>, com tecnologia baseada no projeto <a href="https://github.com/abenzer/represent-map" target="_blank">RepresentMap</a>.
        </p>
      </div>
    ...
    <div class="modal hide" id="modal_add">
      <form action="add.php" id="modal_addform" class="form-horizontal">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">×</button>
          <h3>Adicionar um novo local no mapa</h3>
        </div>
        <div class="modal-body">
          ...
          <fieldset>
            ...
            <div class="control-group">
              <label class="control-label" for="input01">Tipo do Local</label>
              <div class="controls">
                <select name="type" id="add_type" class="input-xlarge">
                  <option value="startup">Educação</option>
                  <option value="accelerator">Saúde</option>
                  <option value="incubator">Esporte</option>
                  <option value="coworking">Lazer</option>
                  <option value="investor">Assistência Social</option>
                  <option value="service">Assistência Jurídica</option>
                  <option value="hackerspace">Organizações Assistenciais</option>
                </select>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label" for="add_title">Nome do Local</label>
              <div class="controls">
                <input type="text" class="input-xlarge" name="title" id="add_title" maxlength="100" autocomplete="off">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label" for="add_address">Endereço do Local</label>
              <div class="controls">
                <input type="text" class="input-xlarge" name="address" id="add_address">
                <p class="help-block">
                  Inclua o endereço <b>completo</b>, incluindo cidade e CEP</b>.
                  Se o endereço é identificado corretamente no Google Maps, perfeito!
                </p>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label" for="add_phone">Telefone do Local</label>
              <div class="controls">
                <input type="text" class="input-xlarge" name="phone" id="add_phone" maxlength="15">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label" for="add_uri">Site do Local</label>
              <div class="controls">
            ...
            <div class="control-group">
              <label class="control-label" for="add_description">Serviços Oferecidos</label>
              <div class="controls">
                ​<textarea name="description" id="add_description" rows="4" cols="80" style="width:270px"></textarea>
                <p class="help-block">
                  Breve descrição sobre os Serviços Oferecidos. Máx 700 caracteres.
                </p>
              </div>
            </div>
          </fieldset>
      ...
      $("#modal_addform").submit(function(event) {
        ...
        $.post( url, { owner_name: owner_name, owner_email: owner_email, title: title, type: type, address: address, uri: uri, description: description },
          function( data ) {
            ...
            if(data == "success") {
              $("#modal_addform #result").html("Recebemos seu novo local. Revisaremos em breve. Muito obrigado!"); 
    ...
    <script type="text/javascript">try{ clicky.init(100613051); }catch(e){}</script>
    <noscript><p><img alt="Clicky" width="1" height="1" src="//in.getclicky.com/100613051ns.gif" /></p></noscript>
  </body>
</html>
